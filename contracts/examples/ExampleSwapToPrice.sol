...
contract ExampleSwapToPrice {
    ...
    IWSRouter public immutable router;
    address public immutable factory;

    constructor(address factory_, IWSRouter router_) public {
        factory = factory_;
        router = router_;
    }
    ...
    function swapToPrice(
        ...
        uint256 amountIn;
        {
            (uint256 reserveA, uint256 reserveB) = WSLibrary.getReserves(factory, tokenA, tokenB);
