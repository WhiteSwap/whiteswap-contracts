...
import { stakingRewardsFixture } from './shared/fixtures'
import { REWARDS_DURATION, expandTo18Decimals, mineBlock, getApprovalDigest } from './shared/utilities'
...
describe('StakingRewards', () => {
  ...
  it('deploy cost', async () => {
    ...
    expect(receipt.gasUsed).to.eq('1494981')
  })
